...
class DecoderLayer(nn.Module): #Transformer
...
class PositionwiseFeedForward(nn.Module): #in DecoderLayer / Transformer
...
class SequenceEmbedding(nn.Module): # in Transformer
    """
